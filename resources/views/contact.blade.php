        ...
        <div class="container mx-auto px-6 lg:px-8 max-w-7xl">
                    ...
                    <div
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start">
                                <div class="text-blue-600 dark:text-blue-400 text-3xl mr-4">
                    ...
                    <form action="#" method="POST" class="space-y-6">
                        <div>
                            ...
                            <input type="text" id="name" name="name" required
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                        ...
                        <div class="text-right">
                            <button type="submit"
                                class="inline-block px-10 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-full text-lg transition duration-300 shadow-lg hover:shadow-xl">
                                Send Message →
                            </button>
                        </div>
                    </form>
            ...
            <div class="mt-16 text-center">
                ...
                <div class="flex justify-center space-x-8">
                    <a href="#"
                        class="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition text-3xl">
